...
quick_plot <- function(
  ...
  if (no_ob_osa) {
    dt <- dt[
      !grepl("EM_236|EM_202|NS_333|EM_204.5", phecode, ignore.case = TRUE)
    ]
  }
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("glp1_sglt2_phewas_", version, "_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("glp1_sglt2_rmst_", version, "_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("glp1_dpp4i_phewas_", version, "_supp_plot.pdf")
  ),
  dpp4i_plots[["patched"]],
  width = 12,
  height = 6,
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("glp1_dpp4i_rmst_", version, "_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("sema_sglt2_phewas_", version, "_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("sema_sglt2_rmst_", version, "_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("sema_dpp4i_phewas_", version, "_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("sema_dpp4i_rmst_", version, "_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("glp1_phewas_", version, "_supp_plot.pdf")
  ),
  glp1_patched,
  width = 12,
  height = 8,
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("glp1_rmst_", version, "_supp_plot.pdf")
  ),
  glp1_rmst_patched,
  width = 12,
  height = 8,
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("sema_phewas_", version, "_supp_plot.pdf")
  ),
  sema_patched,
  width = 12,
  height = 8,
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("sema_rmst_", version, "_supp_plot.pdf")
  ),
  sema_rmst_patched,
  width = 12,
  height = 8,
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("glp1_sglt2_hr_rmst_", version, "_itt_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("glp1_sglt2_hr_rmst_", version, "_pp_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("glp1_dpp4_hr_rmst_", version, "_itt_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("glp1_dpp4_hr_rmst_", version, "_pp_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("sema_sglt2_hr_rmst_", version, "_itt_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("sema_sglt2_hr_rmst_", version, "_pp_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("sema_dpp4_hr_rmst_", version, "_itt_supp_plot.pdf")
  ),
...
ggsave(
  file.path(
    project_directory,
    "figures",
    paste0("sema_dpp4_hr_rmst_", version, "_pp_supp_plot.pdf")
  ),
